...
for which memory is allocated dynamically. Include the member
functions in the class to perform inserting, deleting, searching and
sorting on the array. Call the functions for a float array. */
