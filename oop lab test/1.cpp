...
public:
    ...
    void getdata()
    {
        ...
        cin >> events;
        cout << "\n\nIf not participated,enter score as zero" << endl
             << endl;
    ...
    void display()
    {
        ...
        cout << "Number of events:-" << events << endl
             << endl;
        cout << "Score in event 1:-" << score_in_event1 << endl
             << endl;
        cout << "Score in event 2:-" << score_in_event2 << endl
             << endl;
        cout << "Score in event 3:-" << score_in_event3 << endl
             << endl;
    }
};
int main()
